...
def jogador_vs_dealer():
    ...
    if blackjack(carta1_do_jogador, carta2_do_jogador) == True:
        print("BlackJack!!")
        blackjack_jogador = True
        soma_do_jogador = 21

    elif blackjack(carta1_do_dealer, carta2_do_dealer) == True:
        print("BlackJack!!")
    ...
    if soma_do_jogador == soma_do_dealer:
        print("Empate!")
        ganhou = 0
    elif soma_do_jogador > 21 or  (blackjack_dealer == True) or (soma_do_dealer > soma_do_jogador and soma_do_dealer <= 21):
        print("Você perdeu!")
        ganhou = 2
    elif soma_do_dealer > 21 or (blackjack_jogador == True) or (soma_do_jogador > soma_do_dealer and soma_do_jogador <= 21):
        print("Você venceu!")
        ganhou = 1
